...
import time
from nets import *
from video_data_loader import old_video_dataset
...
train_dataset = old_video_dataset(train = True, classes = all_classes[:total_classes], num_classes = total_classes)
...
for i, (_, inputs, labels) in enumerate(train_dataloader):
    ...
    if (i == 0):
        ...
        convlstm_feat = torch.cat((convlstm_feat, convlstm_feats), 1)
        generator_feat = torch.cat((generator_feat, generator_feats), 1)
