...
class Path(object):
    @staticmethod
    def db_dir(database, all_data=False):
        if database == 'ucf101':
...
class VideoDataset(Dataset):
    ...
    def __init__(self, dataset='ucf101', all_data=False, split='train', clip_len=16, preprocess=False):
        self.root_dir, self.output_dir = Path.db_dir(dataset,all_data)
